...
public class ShopController {
    ...
    void actualizar_consumo_inventario(ActionEvent event) {
        ...
        try{
            ...
            usuario.actualizar_inventario(cn_usuario,input_nombre_jugador_inventario.getValue().toString(),Integer.parseInt(input_item_consumido.getText()),Integer.parseInt(input_cantidad_item_consumido.getText()));
